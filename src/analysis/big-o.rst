...
.. plot::
   ...
   plt.plot(n, np.array([gamma(value + 1) for value in n]))
   plt.plot(n, 2**n)
   plt.plot(n, 2*n**2)
   ...
   plt.text(12, 200, r'$5n\cdot\log_{2}(n)$')
   plt.text(14, 300, '$20n$')
   plt.text(14, 120, '$10n$')
   ...
   .. tb-tab:: Q3
      ...
      .. tb-choice::
         ...
         - [ ] Algorithm 2 will require a greater number of steps to complete than Algorithm 1
           ...
           This could be true depending on the input, but consider the broader picture
         - [x] Algorithm 1 will require a greater number of steps to complete than Algorithm 2 until they reach the crossover point
...
.. tb-group::
   ...
   .. tb-tab:: Run It
      ...
      .. tb-code:: cpp
         :name: ac_analysis_accumulate_bigo
