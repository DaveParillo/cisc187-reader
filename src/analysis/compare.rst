...
.. tb-group::
   ...
   .. tb-tab:: Growth rates
      ...
      .. plot::
         ...
         plt.text(40, 1400, r'$5n\cdot\log_{2}(n)$')
         plt.text(45, 800, '$20n$')
         plt.text(45, 300, '$10n$')
...
.. tb-group::
   :name: analysis_compare_check

   .. tb-tab:: Q1

      .. tb-blank::
         :name: fill_analysis_compare1
         ...
         .. tb-answer::
            :match: 2|3|4
            :feedback: Good job.
            :hint: 0; Not a positive integer.
            :hint: 1; Every algorithm is efficient when :math:`n=1`
            :hint: 5; Factorial cost is already pretty high by :math:`n=5`
            :hint: none; There are 2 values where :math:`n!` is most efficient.
            :match: x

   .. tb-tab:: Q2

      .. tb-parsons::
         :name: pa-analysis-compare1
