...
- `C++ Quiz <https://cppquiz.org/quiz/question/196>`__
...
- `UVa Online Judge <https://onlinejudge.org/>`__
...
- `Code Complete <https://www.goodreads.com/en/book/show/4845.Code_Complete>`__
  A true compendium.
...
- https://www.open-std.org/ is a bare bones site with a huge amount of detailed information
  related to open standards: C, C++, Python, Vulnerability information, and more.

- `Working Well with Legacy Code <https://www.cloudbees.com/blog/what-is-everything-as-code-eac>`__
