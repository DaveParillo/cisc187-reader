...
.. tb-group::
   ...
   .. tb-tab:: Video
      ...
      .. tb-video:: https://www.youtube.com/watch?v=zxb8DvLUqcM
         :name: youtube-zxb8DvLUqcM
...
Displaying numbers
------------------
The standard library provides facilities to modify the base for integers stored
in memory.
...
.. tb-group::
   ...
   .. tb-tab:: ASCII Table
      ...
      .. tb-code:: cpp
         :name: types_ascii_table_example_ac
...
.. tb-group::
   :name: tabbed-skill-check-types

   .. tb-tab:: Q1

      .. tb-match::
         :name: types_dnd_type1

         Match the definition from the left and select the correct concept on
   ...
   .. tb-tab:: Q2
      ...
      .. tb-choice::
         ...
         - [ ] x = 21;
           ...
           Declarations must always include a type. As written, this is
           assignment, not declaration
         - [x] char* s = "hello";

           Correct
         - [x] constexpr int min = 1;
   ...
   .. tb-tab:: Q4
      ...
      .. tb-blank::
         ...
         .. tb-answer::
            :match: -127
            :feedback: Correct.
            :hint: 128; No. ``y`` has been added to ``x``
            :hint: 129; No. The valid range of a signed 8 bit variable is -127 to +128
            :hint: -1; Sorry, no.
            :hint: x; This program compiles and runs.
   ...
   .. tb-tab:: Q5
      ...
      .. tb-blank::
         ...
         .. tb-answer::
            :match: 0
            :feedback: Correct.
            :hint: -1; No. ``-1`` Sets all bits in an int type to 1. ``~`` inverts all the bits.
            :hint: x; This statement compiles and stores a value in ``x``.
   ...
   .. tb-tab:: Q8
      ...
      .. tb-blank::
         ...
         .. tb-answer::
            :match: b
            :feedback: Correct.
            :hint: a; No. array indicies begin at ``0``
            :hint: x; Try again.
...
.. admonition:: More to Explore
   ...
   - `Two's complement <https://www.cs.cornell.edu/~tomf/notes/cps104/twoscomp.html>`__
   ...
   - An interesting alternative to explore, Google Protocol Buffers use
     variable length `zig-zag encoding <https://protobuf.dev/programming-guides/encoding/>`__
   - `Secure Coding in C++: Integers <https://www.sei.cmu.edu/documents/3670/2011_017_001_51345.pdf>`__
