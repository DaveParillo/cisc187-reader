...
.. cpp:: 11
   ...
   C++11 adds :lang:`default <default_constructor>` which instructs the
   compiler to create the default constructor for us.

   .. code-block:: cpp

      talk() = default;

  Since C++11 this syntax is preferred over ``talk() {}``
...
Note that we also changed the name of our function from ``hello`` to ``message``.
...
.. code-block:: cpp
   ...
   class bad_init {
       ...
       int j;
     public:
       bad_init() :i{666}, s{"nothing"} { }  // j is uninitialized
       bad_init(int value) :i{value} {}      // s is "" and j is uninitialized
       // ...
   };
...
.. code-block:: cpp
   ...
   class ok_init {
       ...
       int j {0};
     public:
       ok_init() = default;              // all members initialized to default values
       ok_init(int value) :i{value} {}   // s and j initialized to their defaults
       // ...
   };
