...
course are used not only in the UML, but in other modeling systems as well [#]_
[#]_ [#]_.
   ...
   **Use aggregation judiciously**
   ...
   .. epigraph::
      ...
      **composition** (*black diamond*) does carry semantics.
      ...
      -- Martin Fowler, `AggregationAndComposition blog post <https://martinfowler.com/bliki/AggregationAndComposition.html>`_  17 May 2003.
...
.. admonition:: More to Explore
   ...
   - Scott Ambler has a good
     ...
     <https://agiledata.org/essays/objectOrientation101.html>`__
