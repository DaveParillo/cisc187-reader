...
.. tb-group::
   ...
   .. tb-tab:: assert messages
      ...
      .. tb-code:: cpp
         :name: error_handling_assert_message1_ac
      ...
      .. tb-code:: cpp
         :name: error_handling_assert_message2_ac
...
.. tb-group::
   ...
   .. tb-tab:: bitmask
      ...
      .. tb-code:: cpp
         :name: error_handling_bitmask_ac
