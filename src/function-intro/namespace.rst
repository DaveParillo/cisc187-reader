...
.. tb-group::
   ...
   .. tb-tab:: Stack Overflow
      ...
      .. tb-code:: cpp
         :name: ac_using_namespace_std_so_2
...
.. admonition:: More to Explore
  ...
  - From stack overflow:
    `Why is using namespace std considered bad practice? <https://stackoverflow.com/questions/1452721/whats-the-problem-with-using-namespace-std>`_
