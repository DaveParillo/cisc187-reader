...
.. tb-code:: cpp
   :name: function_parameter_pass_cl1
   :show-tutor:
...
.. tb-code:: cpp
   :name: function_parameter_pass_cl2
   :show-tutor:
...
.. tb-code:: cpp
   :name: function_pass_by_value_ac
...
.. tb-group::
   :name: pointer_vs_ref_tabbed

   .. tb-tab:: Pointers and References
...
and the functions called from ``main``.
   ...
   .. tb-code:: cpp
      :name: function_parameter_pass_by_ref_cl
      :show-tutor:
...
.. tb-group::
   :name: tabbed-skill-check-functions
   ...
   .. tb-tab:: Q1
      ...
      .. tb-blank::
         ...
         .. tb-answer::
            :match: 428
            :feedback: Correct.
            :hint: 123; The variable a is modified in this program.
            :hint: 437; The variable b is never modified in this program.
            :hint: 427; Variable a is modified <em>twice</em> before the addition is performed.
            :incorrect: What is passed to the function change_and_add? What changes? What doesn't?
