   ...
   .. tb-tab:: Q2
      ...
      .. tb-blank::
         ...
         .. tb-answer::
            :match: log\(12\)
            :feedback: Good job.
            :hint: log\(3\*4\); Close. This expression can be even simpler.
            :hint: 1.07 0.05; This is a numeric approximation of the base 10 log, not a simplification.
            :hint: 2.48 0.05; This is a numeric approximation of the natural log, not a simplification.
            :hint: x; Use the rule :math:`\log(a)+\log(b)=\log(a*b)`
   ...
   .. tb-tab:: Q3
      ...
      .. tb-blank::
         ...
         .. tb-answer::
            :match: 1/3
            :feedback: Good job.
            :hint: 0.33 0.05; This is a numeric approximation not an exact solution. Note the cube root of 729 is 9.
            :hint: x; Use the rule if :math:`b^y = x`, then :math:`\log_bx = y`
