...
The :term:`set product` (or Cartesian product) of two sets
...
.. Exercises/Background/SetTFrelation.html ka
...
.. topic:: Example
   ...
   We can use the :doc:`modulus <functions>` function
...
.. Exercises/Background/SetTFequivrel.html ka
