...
All the techniques described in section :doc:`../build-tools/debugging` applies
...
or look at the documentation at https://valgrind.org/ for detailed information about what the output means. 
If you want to run ``valgrind`` on your own machine, 
you may be able to find a version that works at https://valgrind.org/. 
