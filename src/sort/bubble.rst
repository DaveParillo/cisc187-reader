...
.. only:: html
   ...
   .. tb-group::
      :name: bubble-sort-animations

      .. tb-tab:: Average case

         .. tb-video:: ../_static/generated/sort/bubble-sort-average.webm
            :name: bubble-sort-average-video
            :width: 660
            :height: 385
            :thumbnail: ../_static/generated/sort/bubble-sort-average.png

            Bubble sort on a deterministic shuffled input.

      .. tb-tab:: Best case

         .. tb-video:: ../_static/generated/sort/bubble-sort-best.webm
            :name: bubble-sort-best-video
            :width: 660
            :height: 385
            :thumbnail: ../_static/generated/sort/bubble-sort-best.png

            Bubble sort on an already sorted input.

      .. tb-tab:: Worst case

         .. tb-video:: ../_static/generated/sort/bubble-sort-worst.webm
            :name: bubble-sort-worst-video
            :width: 660
            :height: 385
...
.. only:: not html
   ...
   .. figure:: ../_static/generated/sort/bubble-sort-average.png
      :alt: Three static frames of bubble sort on an average case input
      :align: center

      Bubble sort on a deterministic shuffled input.

   .. figure:: ../_static/generated/sort/bubble-sort-best.png
      :alt: Three static frames of bubble sort on an already sorted input
      :align: center

      Bubble sort on an already sorted input.

   .. figure:: ../_static/generated/sort/bubble-sort-worst.png
      :alt: Three static frames of bubble sort on a reverse sorted input
      :align: center
   ...
   .. tb-tab:: Q1
      ...
      .. tb-choice::
         ...
         - [ ] [1, 7, 3, 9, 10, 13, 8, 12, 15, 19]
           ...
           A bubble sort continues to swap numbers up to index position passnum.  But remember that passnum starts at the length of the list - 1.
         - [ ] [1, 9, 19, 7, 3, 10, 13, 15, 8, 12]
