...
C++ uses the legacy :cpp:`null-terminated byte strings library <string/byte>` 
...
.. tb-group::
   :name: cstdlib_byte_string_copy_compare
   ...
   .. tb-tab:: Q1
      ...
      .. tb-blank::
         ...
         .. tb-answer::
            :match: 5
            :feedback: Correct.
            :hint: 6; String length does not include the null character.
            :hint: 4; Sizes are not indexes.
            :hint: x; Try again.
   ...
   .. tb-tab:: Q4
      ...
      .. tb-blank::
         ...
         .. tb-answer::
            :match: string
            :feedback: Correct.
            :hint: cstring; These are not C functions
            :hint: cstdlib; These are string functions added in C++11
            :hint: x; Try again.
