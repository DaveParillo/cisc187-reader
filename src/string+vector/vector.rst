...
.. tb-group::
   :name: tab_vector_simple_access

   .. tb-tab:: Access operations
   ...
   .. tb-tab:: Run It
      ...
      .. tb-code:: cpp
         :name: vector_access_operator_ac1
   ...
   .. tb-tab:: Fill and print vector
      ...
      .. tb-code:: cpp
         :name: vector_fill_and_print_example_ac
...
.. tb-group::
   :name: tab_vector_compare_and_assign

   .. tb-tab:: Compare operations
   ...
   .. tb-tab:: Run It
      ...
      .. tb-code:: cpp
         :name: vector_operator_equal_assign_ac
...
.. admonition:: Try This!
   ...
   .. tb-code:: cpp
      :name: vector_operation_string_compare_try_this_ac
...
.. tb-group::
   :name: tab_vector_push_back

   .. tb-tab:: push_back and pop_back
   ...
   .. tb-tab:: Run It
      ...
      .. tb-code:: cpp
         :name: vector_push_back_example_ac
...
.. tb-group::
   :name: tab_phrase_o_matic_example

   .. tb-tab:: Phrase O'matic
      ...
      .. tb-code:: cpp
         :name: vector_phrase_o_matic_example_ac
...
.. tb-group::
   :name: tab_vector_test_cases_example
   ...
   .. tb-tab:: vector test
      ...
      .. tb-code:: cpp
         :name: vector_test_cases_example_ac
