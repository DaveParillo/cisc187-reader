...
Access and assignment
    :container:`operator= <map/operator%3D>`, :container:`at and operator[] <map/operator_at>`
Capacity
    :container:`empty <map/empty>`, :container:`size <map/size>`, and :container:`max_size <map/max_size>`
Modifiers
    :container:`clear <map/clear>`, :container:`emplace <map/emplace>`, :container:`insert <map/insert>`, :container:`erase <map/erase>`, :container:`swap <map/swap>`
Lookup
    :container:`count <map/count>`, :container:`find <map/find>`, :container:`equal_range <map/equal_range>`, 
    :container:`upper_bound <map/upper_bound>` and :container:`lower_bound <map/lower_bound>`
...
.. tb-code::
   ...
   #include <functional>  // provides std::greater
   #include <iostream>
   #include <map>
   #include <string>
